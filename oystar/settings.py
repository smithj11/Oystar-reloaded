"""
Django settings for oystar project.
...
SECRET_KEY = "django-insecure-kh7&$h2fw)5d7^%0%b$=fk2$(k92uk5^dzam^a(==c4g2+yfht"
...
INSTALLED_APPS = [
    ...
    "oystar.apps.accounts.apps.AccountsConfig",
]
...
WSGI_APPLICATION = "oystar.wsgi.application"
